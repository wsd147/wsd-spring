...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			// If the length permission is given, but the init display length is not, use the length permission
	...
	DataTable.defaults = {
		 ...
		 * down permission that DataTables shows when pagination is enabled. It can be
		 ...
		 * permission (sizes are 10, 25, 50 and 100). Requires pagination (`paginate`).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Features
		 ...
		 * this to a custom setting using a pop-up permission.
		 *  @type int
		 *  @default 10
		 *
		 *  @dtopt Options
		...
		"oLanguage": {
			...
			/**
			 * Detail the action that will be taken when the drop down permission for the
	...
	DataTable.models.oSettings = {
		...
		/**
		 * List of options that can be used for the user selectable length permission.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
