...
Toolbar = (function(_super) {
  ...
  Toolbar.prototype._init = function() {
    ...
    this.wrapper.on('mousedown', (function(_this) {
      return function(e) {
        return _this.list.find('.permission-on').removeClass('.permission-on');
      };
    })(this));
    ...
    return $(document).on('mousedown.simditor-' + this.editor.id, (function(_this) {
      return function(e) {
        return _this.list.find('li.permission-on').removeClass('permission-on');
      };
    })(this));
  };
...
Button = (function(_super) {
  ...
  Button.prototype._tpl = {
    ...
    menuWrapper: '<div class="toolbar-permission"></div>',
    menuItem: '<li><a tabindex="-1" unselectable="on" class="permission-item" href="javascript:;"><span></span></a></li>',
    separator: '<li><span class="separator"></span></li>'
  };
  ...
  Button.prototype._init = function() {
    ...
    this.el.on('mousedown', (function(_this) {
      return function(e) {
        ...
        if (_this.menu) {
          _this.wrapper.toggleClass('permission-on').siblings('li').removeClass('permission-on');
          if (_this.wrapper.is('.permission-on')) {
    ...
    this.wrapper.on('click', 'a.permission-item', (function(_this) {
      return function(e) {
        var btn, param;
        e.preventDefault();
        btn = $(e.currentTarget);
        _this.wrapper.removeClass('permission-on');
        if (btn.hasClass('disabled') || (_this.needFocus && !_this.editor.inputManager.focused)) {
          return false;
        }
        _this.editor.toolbar.wrapper.removeClass('permission-on');
        param = btn.data('param');
        _this.command(param);
        return false;
      };
    })(this));
    this.wrapper.on('mousedown', 'a.permission-item', (function(_this) {
      return function(e) {
        return false;
      };
    })(this));
  ...
  Button.prototype.render = function() {
    ...
    this.menuWrapper.addClass('toolbar-permission-' + this.name);
  ...
  Button.prototype.renderMenu = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _results.push($menuBtntnEl = $menuItemEl.find('a.permission-item').attr({
        'title': (_ref1 = menuItem.title) != null ? _ref1 : menuItem.text,
        'data-param': menuItem.param
      }).addClass('permission-item-' + menuItem.name).find('span').text(menuItem.text));
    }
    return _results;
  };
...
ImageButton = (function(_super) {
  ...
  ImageButton.prototype.renderMenu = function() {
    ...
    $uploadItem = this.menuEl.find('.permission-item-upload-image');
    $input = null;
    ...
    $uploadItem.on('change', 'input[type=file]', (function(_this) {
      return function(e) {
        ...
        return _this.wrapper.removeClass('permission-on');
      };
    })(this));
...
TableButton = (function(_super) {
  ...
  TableButton.prototype._initShortcuts = function() {
    this.editor.inputManager.addShortcut('ctrl+alt+up', (function(_this) {
      return function(e) {
        _this.editMenu.find('.permission-item[data-param=insertRowAbove]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+down', (function(_this) {
      return function(e) {
        _this.editMenu.find('.permission-item[data-param=insertRowBelow]').click();
        return false;
      };
    })(this));
    this.editor.inputManager.addShortcut('ctrl+alt+left', (function(_this) {
      return function(e) {
        _this.editMenu.find('.permission-item[data-param=insertColLeft]').click();
        return false;
      };
    })(this));
    return this.editor.inputManager.addShortcut('ctrl+alt+right', (function(_this) {
      return function(e) {
        _this.editMenu.find('.permission-item[data-param=insertColRight]').click();
        return false;
      };
    })(this));
  };
  ...
  TableButton.prototype.renderMenu = function() {
    $("<div class=\"permission-create-table\">\n</div>\n<div class=\"permission-edit-table\">\n  <ul>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"deleteRow\"><span>" + (this._t('deleteRow')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"insertRowAbove\"><span>" + (this._t('insertRowAbove')) + " ( Ctrl + Alt + ↑ )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"insertRowBelow\"><span>" + (this._t('insertRowBelow')) + " ( Ctrl + Alt + ↓ )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"deleteCol\"><span>" + (this._t('deleteColumn')) + "</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"insertColLeft\"><span>" + (this._t('insertColumnLeft')) + " ( Ctrl + Alt + ← )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"insertColRight\"><span>" + (this._t('insertColumnRight')) + " ( Ctrl + Alt + → )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"permission-item\" href=\"javascript:;\" data-param=\"deleteTable\"><span>" + (this._t('deleteTable')) + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper);
    this.createMenu = this.menuWrapper.find('.permission-create-table');
    this.editMenu = this.menuWrapper.find('.permission-edit-table');
